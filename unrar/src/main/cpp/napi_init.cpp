...
static napi_value napi_Extract(napi_env env, napi_callback_info info) {
...
static napi_value napi_ExtractSync(napi_env env, napi_callback_info info) {
    wchar_t nameW[NM];
    struct RAROpenArchiveDataEx data {};
    memset(nameW, 0, sizeof(char) * NM);
    size_t requireArgc = 3;
...
static napi_value Init(napi_env env, napi_value exports) 
{
    napi_property_descriptor desc[] = {
        ...
        { "extract", nullptr, napi_Extract, nullptr, nullptr, nullptr, napi_default, nullptr },
        { "extractSync", nullptr, napi_ExtractSync, nullptr, nullptr, nullptr, napi_default, nullptr }
    };
